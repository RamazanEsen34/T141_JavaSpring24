...
public class C02_Concatenation {
    ...
    public static void main(String[] args) {
        ...
        System.out.println(s4+b+a+s1);// 45Java

        System.out.println(""+b+a+s1);// 45Java

        // "45" i nasil integere cevirip 1 ekleriz

        String str ="45";

        System.out.println(Integer.parseInt(str)+1);// 46

        // Integer olarak verilen bir sayiyi nasil stringe ceviririz

        int sayi = 45;
        String metin = "" +45;

        System.out.println(metin);// 45
