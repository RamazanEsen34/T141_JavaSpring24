...
public class C02_ArabaRunner {
    public static void main(String[] args) {
        ...
        /*
            ...
            olusturdugu class'daki
            TUM INSTANCE variable'lerin ve degerlerinin
            ...
            Diger bir deyisle
            Bir constructor calismadan bir obje olusturulup
            ona ilk deger atamasi yapmak mumkun degildir

            Constructor'lar () kullandiklari icin
            method'lara benzetilirler
            ama constructorlar java'da ayri bir yapidir

            Java her class'da obje olusturabilmesini
            saglamak icin her class' DORUNMEYEN
            Default bir constructor koymustur.

            Yani bir class'da gozle gorulebilir constructor yoksa
      ...
      // Class adi      obje adi    atama isareti    key word      constructor
