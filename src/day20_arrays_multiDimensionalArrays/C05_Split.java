...
public class C05_Split {
    public static void main(String[] args) {
        ...
        // str daki kelme sayisini yazdirin
        // " " (space) ie split yapariz

        System.out.println(Arrays.toString(str.split(" ")));// [Ali, topu, at,, at, Ali, at]

        System.out.println("Kelime sayisi :" + str.split(" ").length);// Kelime sayisi :6

        // str'i karakterlerine ayirin
        // bu defa "" (hiclik ) kullanarak ayiririz

        System.out.println(Arrays.toString(str.split("")));//[A, l, i,  , t, o, p, u,  , a, t, ,,  , a, t,  , A, l, i,  , a, t]
        System.out.println("Harf sayisi :" + str.split("").length);// Harf sayisi :22
